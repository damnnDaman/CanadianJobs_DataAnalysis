...
#command line example $python3 pre_process_question3.py "14100328.csv" > "pre_process_question3.csv"
'''
pre_process_question3.py
  Author(s): Jacob Good (1300566)
  Earlier contributors(s): Daman Kumar (1306900), Jacob Good (1300566), Ryan Sass-Gregoire(1230473), Hamza Irshad (1261380)

  Project: Milestone II Pre Process Data For Question 3
  Date of Last Update: Mar 12, 2024.

  Functional Summary
      pre_process_question3.py takes in a CSV (comma separated version) file. Then filters the data of occupational classification of 
      “Software engineers and designers [2173]”, that further refer to “Job vacancies”.
...
def main (argv):
    ...
    for i in file_reader:
        ...
        if (i[3] == "Software engineers and designers [2173]" and i[5]=="Job vacancies"):
            if (i[12] != ""):
                print(i[0],i[1],i[3],i[4],i[5],i[12], sep = ",")
    file_data.close()
